...
| Submission PDF | `docs/Cytomove_manuscript_submission.pdf` | Rebuild required after current DOCX edits |
| References | `docs/references/cytomove-preprint.bib` | Ready |
| Figures | `docs/manuscript_figures/` | Ready |
| Validation artifact package | `docs/Cytomove_zenodo_deposit_enriched_doi.zip` | Rebuild required after current DOCX/PDF edits |
...
- [ ] Regenerate `docs/Cytomove_manuscript_submission.pdf` from the current DOCX.
- [ ] Refresh `docs/zenodo_deposit/Cytomove_manuscript_submission.pdf` and rebuild `docs/Cytomove_zenodo_deposit_enriched_doi.zip` so the deposit copy matches the edited manuscript before upload.

---

## Submission Sequence

1. Rebuild `docs/Cytomove_zenodo_deposit_enriched_doi.zip`, then upload it to Zenodo as Record A.
