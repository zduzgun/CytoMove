...
<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
  ...
  function askCustomGroupName(files) {
    ...
    const typed=window.prompt('Group name',suggested);
    const label=(typed===null?suggested:typed.trim())||suggested;
    return label;
  }
  ...
  function bindEvents() {
    ...
    el.fileInput.addEventListener('change',e=>{loadLocalFiles(e.target.files); e.target.value='';});
