...
Cytomove Desktop Beta is gated behind a verified academic beta account. On launch the app shows a
...
- `Cytomove-Desktop-Beta-<version>-setup.exe` (installer, recommended)
- `Cytomove-Desktop-Beta-<version>-portable.exe` (single-file, no install)
...
which shows download links only to signed-in, verified beta accounts.
