Cytomove Desktop Beta 0.1

Purpose
This is a Windows desktop beta for verified academic testing of Cytomove wound-healing analysis.

Sign-in
The desktop app requires a verified academic beta account. On launch you will see a sign-in screen
...
- Multi-image group loading.
- Group PNG ZIP export.
- Plots ZIP export.
- CSV / Excel export.
...
Known notes
- TIFF is not recommended for this beta. Use PNG/JPG where possible.
